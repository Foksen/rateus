        ...
        http
                ...
                .authorizeHttpRequests(authorizeRequests ->
                        authorizeRequests
                                ...
                                .requestMatchers(HttpMethod.GET, "/organizations").hasAnyRole("MODERATOR", "ADMIN")
                                ...
                                .requestMatchers(HttpMethod.GET, "/reviews").hasAnyRole("MODERATOR", "ADMIN")
                                .requestMatchers(HttpMethod.GET, "/reviews/public/**").permitAll()
                                .requestMatchers(HttpMethod.GET, "/briefs/organizations").hasAnyRole("MODERATOR", "ADMIN")
                                .requestMatchers(HttpMethod.GET, "/briefs/reviews").hasAnyRole("MODERATOR", "ADMIN")
